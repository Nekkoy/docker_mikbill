...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=koi8r AVG_ROW_LENGTH=910;
...
(19, 'Наден по MAC - PON/ОНУ', 1),
(20, 'Найден по Serial - PON/ОНУ', 1);
...
--
ALTER TABLE `switch_opt82_logtype`
MODIFY `logtypeid` tinyint(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
