...
ALTER TABLE `mod_omnicell_transactions` ADD `request_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'время отправки запроса' AFTER `operation_name`;
