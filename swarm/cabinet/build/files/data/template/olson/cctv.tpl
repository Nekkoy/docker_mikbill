    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("Видеонаблюдение"); ?> </h2>
                <hr/>
            </div>
            <!-- Page title -->
            ...
            <div class="awidget" id="step_2">
                ...
                <div class="awidget-body no-table-bor">
                    <ul class="list-group">
                        <?php if(empty($this->val['subscriptions']['cameras'])){ ?>
                        <div class="alert alert-warning">
                            <i class="icon-warning-sign"></i> <?php echo T_("К сожалению для Вас нет доступных камер. Обратитесь в техподдержку."); ?>
                        </div>
                        <?php } ?>
                        <?php foreach($this->val['subscriptions']['cameras'] as $camera){ ?>
                        <li class="list-group-item">
                            <div class="awidget-head">
                                <h3><?php echo $camera['title']; ?>:</h3>
                            </div>
                            <embed src="<?php echo $camera['playback_url']; ?>" width="100%" height="600" >
                        </li>
                        <?php } ?>
                    </ul>
                </div>
