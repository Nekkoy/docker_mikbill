    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("Oll.tv"); ?> </h2>
                <hr/>
            </div>
            <!-- Page title -->
            ...
            <?php if( !empty($this->val['subscriptions']['devices']) ) { ?>
                    ...
                    <ul class="list-group">
                        <div class="row">
                            <div class="form-group">
                                <div class="col-xs-3"><span><?php echo T_("Модель"); ?></span></div>
                                <div class="col-xs-3"><span><?php echo T_("Серийный номер"); ?></span></div>
                                <div class="col-xs-3"><span><?php echo T_("MAC адрес"); ?></span></div>
                                <div class="col-xs-3"><span><?php echo T_("Код привязки"); ?></span></div>
                            </div>
                        </div>
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-xs-3"><span><?php echo $device['device_model']; ?></span></div>
                                    <div class="col-xs-3"><span><?php echo $device['serial']; ?></span></div>
                                    <div class="col-xs-3"><span><?php echo $device['mac']; ?></span></div>
                                    <div class="col-xs-3"><span><i class="icon-key"></i> <?php echo $device['binding_code']; ?></span></div>
                                </div>
                            </div>
                        </li>
                        <?php } ?>
