    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("Бонусы"); ?> </h2>
                <hr/>
            </div>
            <!-- Page title -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-info"> <?php echo T_("Доступно"); ?>: <?php echo $this->val['bonus_points']; ?> <?php echo T_("бонусных баллов."); ?></div>

                    <?php if(isset($this->val['shop_success'])){ ?>
                        <div class="alert alert-success"> <?php echo $this->val['shop_success']; ?></div>
                    <?php } ?>

                    <?php if(isset($this->val['shop_error'])){ ?>
                    <div class="alert alert-danger"> <?php echo $this->val['shop_error']; ?></div>
                    <?php } ?>
            ...
            <div class="row">
                ...
                <?php foreach($this->val['shop_items'] as $row){ ?>

                    <div class="col-xs-12 item-grid col-md-12 col-sm-12">
                        <div class="awidget">
                            <div class="awidget-body no-table-bor">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="item-image">
                                            <a href="<?php echo $row['url']; ?>">
                                                <picture>
                                                    <img width="145" height="145" src="/json/users/shop/image/<?php echo $row['id']; ?>" class="center-block">
                                                </picture>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-sm-9">
                                        ...
                                        <h5><a href="<?php echo $row['url']; ?>" ><?php echo $row['name']; ?> </a></h5>

                                        <div class="clearfix"></div>
                                        <p><b><?php echo T_("Описание"); ?></b>: <?php echo $row['descriptions']; ?></p>
                                        <hr>

                                        <div class="item-price pull-left price-curry"><i class="fas fa-gift"></i> <?php echo $row['points']; ?> <?php echo T_("баллов"); ?></div>
                                        <div class="pull-right">
                                            <form method="post">
                                                <input type="hidden" name="bonus" value="true">
                                                <input type="hidden" name="checkout" value="true">
                                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                                <button type="submit" class="btn btn-sm btn-info"><?php echo T_("Обменять"); ?></button>
                                            </form>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
