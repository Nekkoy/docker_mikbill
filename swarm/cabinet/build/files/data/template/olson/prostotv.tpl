    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("ProstoTV"); ?> </h2>
                <hr/>
            </div>
            <!-- Page title -->
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    <form  method="post" action="/index/main">
                        ...
                        <input type="hidden" class="form-control" name="lkview" value="prostotv">
                        <input type="hidden" class="form-control" name="remove_device" value="<?php echo $device['id']; ?>">

                        <div class="row">
                            <div class="form-group">
                                <div class="col-xs-6"><?php echo $device['device']; ?></div>
                                <div class="col-xs-3"><span><?php echo $device['created']; ?></span></div>
                                <div class="col-xs-3">
                                    <span>
                                        <button type="submit" class="btn btn-xs btn-danger" onclick="">Remove</button>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <li class="list-group-item">
                    <form  method="post" action="/index/main">
                        ...
                        <input type="hidden" class="form-control" name="lkview" value="prostotv">
                        <input type="hidden" class="form-control" name="remove_playlist" value="<?php echo $playlist['id']; ?>">

                        <div class="row">
                            <div class="form-group">
                                <div class="col-xs-6"><?php echo $playlist['device']; ?></div>
