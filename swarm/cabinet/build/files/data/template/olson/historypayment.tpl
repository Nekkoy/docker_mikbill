    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("История платежей"); ?> </h2>
                <hr/>
            </div>
            <!-- Page title -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="dataTable_wrapper">
                                <table class="display table compact table-striped table-bordered" id="dataTables-example">
                                    <thead>
                                    <tr>
                                        <th><?php echo T_("Дата"); ?></th>
                                        <th><?php echo T_("Тип платежа"); ?></th>
                                        <th><?php echo T_("До платежа"); ?></th>
                                        <th><?php echo T_("Сумма"); ?></th>
                                        <th class="hide_on_mobile"><?php echo T_("Примечание"); ?></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php foreach( $this->val['historySessionArray'] as $key => $item ) { ?>
                                        <tr>
                                            <td><?php echo $item['date']; ?></td>
                                            <td><?php echo T_($item['bugh_type']); ?></td>
                                            <td><?php echo $item['before_billing']; ?></td>
                                            <td><?php echo $item['summa']; ?></td>
                                            <td class="hide_on_mobile"><?php echo $item['comment']; ?></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
