            ...
            <div class="awidget col-md-12">
                <?php if( !empty($this->val['alter']) ) { ?>
                    ...
                    <div class="awidget-body no-table-bor">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a type="button" class="btn btn-default" href="/index/main/lkview/lifecell"><?php echo T_("Вернуться"); ?></a>
                            </div>
                        </div>
                    </div>
                <?php } else { ?>
                    <form method="post" action="/index/main/lkview/lifecellresult">
                        <div class="awidget-head">
                            <h3><?php echo T_("Подтверждение заказа"); ?></h3>
                        </div>
                        ...
                        <div class="awidget-body no-table-bor">
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <?php echo T_("Заказ"); ?>: <?php echo $this->val['item']['name']; ?>
                                        </div>
                                    </div>
        
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <?php echo T_("Цена"); ?>: <?php echo $this->val['item']['price']; ?> <?php echo $this->val['item']['currency']; ?>
                                        </div>
                                    </div>

                                    <?php if( isset($this->val['item']['returnSumma']) ) { ?>
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <?php echo T_("Сумма возврата за текущий тариф"); ?>: <?php echo $this->val['item']['returnSumma']; ?> <?php echo $this->val['item']['currency']; ?>
                                            </div>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <?php echo T_("Время действия до"); ?>: <?php echo $this->val['item']['dateEnd']; ?>
                                        </div>
                                    </div>
                                    
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <?php echo T_("Описание"); ?>: <br><?php echo T_($this->val['item']['description']); ?>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <a type="button" class="btn btn-default" href="/index/main/lkview/lifecell"><?php echo T_("Отменить заказ"); ?></a>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <?php echo T_($this->val['item']['inputHTML']); ?>
                                        <button id="confirmOrder" type="submit" class="btn btn-primary"><?php echo T_("Подтвердить заказ"); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
