    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("TRINITY-TV"); ?> </h2>
                <hr/>
            </div>
            <!-- Page title -->
            ...
            <div class="awidget" id="step_2">
                ...
                <div class="awidget-body no-table-bor">
                    ...
                    <table class="table">
                        <?php $i=1; foreach($this->val['subscriptions']['devices'] as $device) { ?>
                        <form  method="post" action="/index/main">
        
                            <input type="hidden" class="form-control" name="lkview" value="trinitytv">
                            <input type="hidden" class="form-control" name="remove_device" value="<?php echo $device['devid']; ?>">
        
                            <tr id="mac<?php echo $device['devid']; ?>">
                                <td>ID: <?php echo $i ?></td>
                                <td>MAC: <?php echo $device['dev_mac']; ?></td>
                                <td><button type="submit" id="macdel<?php echo $device['devid']; ?>" class="btn btn-danger");"><?php echo T_("Удалить"); ?></button></td>
                            </tr>
                        </form>
                    ...
                    <form class="form-horizontal" id="form_mac_add">
        
                        <input type="hidden" class="form-control" name="lkview" value="trinitytv">
        
                        <div class="form-group">
                            <label for="dev_type"
                                   class="col-sm-3 control-label"><?php echo T_("Тип устройства"); ?>:</label>
                            <div class="col-sm-4">
                                <select type="text" class="form-control" id="dev_type" name="dev_type" required>
                                    <?php foreach ($this->val['subscriptions']['device_types'] as $devType) { ?>
                                    <option value="<?php echo $devType['devtypeid']; ?>"><?php echo htmlentities($devType['devtypename'],ENT_QUOTES,'UTF-8'); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="mac"
                                   class="col-sm-3 control-label"><?php echo T_("Добавить MAC"); ?>:</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="mac" name="dev_mac" value="" required>
                            </div>
                        </div>
        
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-10">
                                <button type="submit" id="macaddb" class="btn btn-info"><?php echo T_("Добавить"); ?></button>
                            </div>
                        </div>
        
                        <div class="alert alert-info"><i class="icon-warning-sign"></i> <?php echo T_("Макcимально возможно 4 MAC адреса устройств"); ?></div>
                    </form>
        
                    <form class="form-horizontal" id="form_code_add">
                        ...
                        <div class="form-group">
                            <label for="dev_type2"
                                   class="col-sm-3 control-label"><?php echo T_("Тип устройства"); ?>:</label>
                            <div class="col-sm-4">
                                <select type="text" class="form-control" id="dev_type2" name="dev_type" required>
                                    <?php foreach ($this->val['subscriptions']['device_types'] as $devType) { ?>
                                    <option value="<?php echo $devType['devtypeid']; ?>"><?php echo htmlentities($devType['devtypename'],ENT_QUOTES,'UTF-8'); ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group">
                            <label for="mac"
                                   class="col-sm-3 control-label"><?php echo T_("Ввести код"); ?>:</label>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-10">
                                <button type="submit" id="codeaddb" class="btn btn-info"><?php echo T_("Добавить"); ?></button>
                            </div>
                        </div>
                        <div class="alert alert-info hide" id="codeadd"></div>
                        <div class="alert alert-info"><i class="icon-warning-sign"></i> <?php echo T_("Код доступа отображается в виде четырех цифр на телевизоре.<br>Действует 5 минут с момента показа."); ?></div>
                    </form>
