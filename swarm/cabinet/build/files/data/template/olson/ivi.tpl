...
<head>
    ...
    <!-- notify -->
    <link href="/data/template/<?php echo $this->val['template_dir']; ?>/css/toastr.css" rel="stylesheet"/>
    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("Подписка IVI.RU"); ?> </h2>
                <hr/>
            </div>
            <!-- Page title -->
...
<!-- notify -->
<script src="/data/template/<?php echo $this->val['template_dir']; ?>/js/toastr.js"></script>
