        ...
        <div class="container">
            ...
            <div class="mainy">
                ...
                <div class="page-title">
                    <h2><i class="icon-desktop color"></i> <?php echo T_("История сессий"); ?> </h2>
                    <hr/>
                </div>
                <!-- Page title -->
                            ...
                            <div class="panel-body">
                                ...
                                <div class="dataTable_wrapper">
                                    <table class="display table compact table-striped table-bordered" id="dataTables-example">
                                        <thead>
                                        <tr>
                                            <th><?php echo T_("Подключено"); ?></th>
                                            <th><?php echo T_("Отключено"); ?></th>
                                            <th><?php echo T_("Время"); ?></th>
                                            <th><?php echo T_("Входящий"); ?></th>
                                            <th><?php echo T_("Исходящий"); ?></th>
                                            <th class="hide_on_mobile"><?php echo T_("IP/MAC"); ?></th>
                                            <th><?php echo T_("Снято"); ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
    
                                        <?php foreach ($this->val['historySessionArray'] as $key) { ?>
    
                                        <tr>
                                            <td><?php echo $key['start_time']; ?></td>
                                            <td><?php echo $key['stop_time']; ?></td>
                                            <td><?php echo $key['time_on']; ?></td>
                                            <td><?php echo $key['in_bytes']; ?></td>
                                            <td><?php echo $key['out_bytes']; ?></td>
                                            <td class="hide_on_mobile">
                                                <?php
                                                    echo "{$key['ipaddress']} / {$key['call_from']}";
                                                ?>
                                            </td>
                                            <td><?php echo $key['billing_minus']; ?></td>
                                        </tr>
                                        <?php } ?>
