    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("Контакты"); ?> </h2>
                <hr/>
            </div>
            <!-- Page title -->
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="awidget">
                        <div class="awidget-head">
                            <h3><?php echo T_("Контактная информация"); ?></h3>
                        </div>
                        
                        <div class="awidget-body no-table-bor">
                            <table class="table">
                                <tr>
                                    <td><?php echo T_("Компания"); ?>:</td>
                                    <td><?php echo $this->val['company_name']; ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo T_("Адрес"); ?>:</td>
                                    <td><?php echo $this->val['company_adress']; ?></td>
                                </tr>
                                <tr>
                                    <td>E-mail:</td>
                                    <td><?php echo $this->val['company_e-mail']; ?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="awidget">
                        <div class="awidget-head">
                            <h3><?php echo T_("Телефоны"); ?></h3>
                        </div>
                        <div class="awidget-body no-table-bor">
                            <table class="table">
								<?php if ( isset($this->val['cab_name_mobile_1']) && $this->val['cab_name_mobile_1'] != "" ) { ?>
                                <tr>
                                    <td><?php echo $this->val['cab_name_mobile_1']; ?>:</td>
                                    <td><?php echo $this->val['cab_phone_mobile_1']; ?></td>
                                </tr>
								<?php } ?>
								<?php if ( isset($this->val['cab_name_mobile_2']) && $this->val['cab_name_mobile_2'] != "" ) { ?>
                                <tr>
                                    <td><?php echo $this->val['cab_name_mobile_2']; ?>:</td>
                                    <td><?php echo $this->val['cab_phone_mobile_2']; ?></td>
                                </tr>
								<?php } ?>
								<?php if ( isset($this->val['cab_name_mobile_3']) && $this->val['cab_name_mobile_3'] != "" ) { ?>
                                <tr>
                                    <td><?php echo $this->val['cab_name_mobile_3']; ?>:</td>
                                    <td><?php echo $this->val['cab_phone_mobile_3']; ?></td>
                                </tr>
								<?php } ?>
                            </table>
                        </div>
            ...
            <div class="row">
                <?php if (isset($this->val['company_info']['show_map']) and $this->val['company_info']['show_map'] == 1) { ?>
                    <div class="col-md-12">
                        <!-- Browser widget -->
                        <div class="awidget">
                            <div class="awidget-head">
                                <h3><?php echo T_("Карта проезда"); ?></h3>
                            </div>
                            <div class="awidget-body no-table-bor">
                                <div class="element">
									<a href="/data/template/<?php echo $this->val['template_dir']; ?>/img/map.jpg" class="prettyphoto">
                                        <center><img src="/data/template/<?php echo $this->val['template_dir']; ?>/img/map.jpg" alt=""/></center>
									</a>
								</div>
                            </div>
                        </div>
