    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("MOOVI"); ?> </h2>
                <hr/>
            </div>
            ...
            <!-- Begin. MOOVI info -->
            <?php if(!empty($this->val['subscriptions']['info'])) { ?>
                <div class="awidget" id="step_2">
                    <div class="awidget-head">
                        <h4> <i class="icon-info"> </i> MOOVI:</h4>
                        <hr>
                    </div>
                    ...
                    <div class="awidget-body no-table-bor">
                        <div class="alert alert-info">
                            ...
                            <br>
                            <?php echo T_("Пароль"); ?>: <?php echo $this->val['subscriptions']['info']['pin']; ?>
                        </div>
                    </div>
                </div>
            <?php } ?>
