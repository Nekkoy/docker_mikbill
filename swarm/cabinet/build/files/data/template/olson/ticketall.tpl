                    ...
                    <div class="col-md-12">
                        <div class="awidget">
                            <div class="awidget-head">
                                <h3><?php echo T_("Все диалоги"); ?>:</h3>
                            </div>
                            <div class="awidget-body">
                                <div class="dataTable_wrapper">
                                    <table class="display table compact table-striped table-bordered"
                                        id="dataTables-example">
                                        <thead>
                                            <tr>
                                                <th><?php echo T_("ID"); ?></th>
                                                <th><?php echo T_("Cooбщение"); ?></th>
                                                <th><?php echo T_("Дата создания"); ?></th>
                                                <th><?php echo T_("Статус"); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php echo $this->val["ticket_all"]; ?>
                                        </tbody>
                                    </table>
