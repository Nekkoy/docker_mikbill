    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("Перевод средств"); ?> </h2>
                <hr/>
            </div>
            <!-- Page title -->
            ...
            <div class="awidget" id="step_1">
                <div class="awidget-head">
                    <h3> <?php echo T_("Подтвердите перевод средств"); ?>:</h3>
                </div>

                <div class="awidget-body no-table-bor">

                    <?php echo $this->val['cabinet_perevod_alert']; ?>

                    <form class="form-horizontal" action="/index/main" method="post">

                        <input type="hidden" class="form-control" name="lkview" value="perevod">

                        <div class="form-group">
                            <label class="control-label col-lg-2"><?php echo T_("Сумма перевода"); ?>:</label>

                            <div class="col-lg-6 ">
                                <input name="summa" id="summa" type="number" min="1" value="1" step="0.2"
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-2"><?php echo T_("Получатель UID"); ?>:</label>

                            <div class="col-lg-6">
                                <input type="number" name="to_uid" min="1" id="uid" class="form-control">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-lg-2"><?php echo T_("Примечание"); ?>:</label>

                            <div class="col-lg-6">
                                <input type="input" name="note" id="note" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-lg-offset-2">
                                <div class="alert alert-info">
                                    <?php echo T_("Сумма комиссии составит"); ?>  <span id="label_komiss">0</span>  <?php echo $this->val['UE']; ?> <br>  <?php echo T_("Итого будет снято со счета"); ?>: <span id="label_itogo" >0</span>  <?php echo $this->val['UE']; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-lg-offset-2">
                                ...
                                <label class="checkbox inline">
                                    <input type="checkbox" id="i_agree" value="agree"> <?php echo T_("Я согласен перевести средства указанному получателю."); ?>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="password" name="oldpass" class="form-control" id="oldpass" disabled>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function do_change_summ() {
            var do_perevod_fixed = Number( <?php echo $this->val['do_perevod_fixed']; ?>);
            var perevod_summa = Number( <?php echo $this->val['perevod_summa']; ?>);
            var summa = Number($("#summa").val());

            var komiss;
            var itogo;

            if (do_perevod_fixed == 1) {
                komiss = perevod_summa;
            } else {
                komiss = summa * perevod_summa / 100;
            }

            itogo = summa + komiss;

            $("#label_komiss").html(Math.ceil(komiss*100)/100);
            $("#label_itogo").html(Math.ceil(itogo*100)/100);
        }
