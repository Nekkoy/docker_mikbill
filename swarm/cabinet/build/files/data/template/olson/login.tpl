        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="logo text-center">
                    <h1><a href="<?php echo $this->val['company_site']; ?>"><?php echo $this->val['company_name']; ?></a></h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="awidget login-reg">
                    ...
                    <div class="awidget-body">
                        ...
                        <div class="page-title text-center">
                            <h2><?php echo T_("Вход"); ?></h2>
                        </div>
                        <!-- Page title -->

                        <br/>

                        <form class="form-horizontal"  id="formlogin" role="form" action="/index/main" method="post">
                            <?php if( isset($this->val['cab_login_alert'])) {echo $this->val['cab_login_alert'];} ?>
                            <?php if( isset($this->val['cabinet_auth_alert'])) {echo $this->val['cabinet_auth_alert'];} ?>
                            ...
                            <?php if (isset($this->val['gui']['restore_pass_sms_on']) and $this->val['gui']['restore_pass_sms_on'] == '1'){ ?>
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-5">
                                    <a href="/index/main/lkview/restore"><?php echo T_("Забыли пароль?"); ?></a>
                                </div>
                            </div>
                            <?php } ?>
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button type="submit" id="demo" class="btn btn-info"><i class="icon-signin"></i> <?php echo T_("Вход"); ?></button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#register").click(function () {
            location.href= "/index/main/lkview/register";
        });
    });
