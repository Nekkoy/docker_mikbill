    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("Wink"); ?> </h2>
                <hr/>
            </div>
            
            <!-- Page title -->
            <?php if(!(isset($this->val['subscriptions']['info']['activate']) AND $this->val['subscriptions']['info']['activate'])) { ?>
                <div class="alert alert-success"> <?php echo T_(" Уважаемый абонент! <br> Ваш аккаунт Wink еще создается, зайдите через несколько минут..."); ?></div>
            <?php } else { ?>
                <!-- Page title -->
                ...
                <!-- Begin. Wink info -->
                <?php if(isset($this->val['subscriptions']['info']['activate']) AND $this->val['subscriptions']['info']['activate'] == 1) { ?>
                    <div class="awidget" id="step_2">
                        <div class="awidget-head">
                            <h4> <i class="icon-info"> </i> Info Wink:</h4>
                            <hr>
                        </div>
                        
                        <div class="awidget-body no-table-bor">
                            <div class="alert alert-info">
                                <strong><?php echo T_("Ваш код активации Wink"); ?>:</strong>
                                <br>
                                <h2><?php echo $this->val['subscriptions']['info']['code']; ?></h2>
                            </div>
                
                            <form class="form-horizontal" role="form" method="post">
                                <input type="hidden" class="form-control" name="lkview" value="wink">
                                <input type="hidden" class="form-control" name="wink_action" value="reset_code">
                
                                <hr>
                                <div class="form-group">
                                    <!-- Buttons -->
                                    <div class="col-lg-6 ">
                                        <button class="btn btn-default"><?php echo T_("Сбросить код"); ?></button>
                                        <a href="https://wink.rt.ru/activation?ott_tv_code=<?php echo $this->val['subscriptions']['info']['code']; ?>" class="btn btn-info" target="_blank">
                                            <i class="icon-signin"></i> <?php echo T_("Активация"); ?>
                                        </a>
                                    </div>
                                </div>
                            </form>
