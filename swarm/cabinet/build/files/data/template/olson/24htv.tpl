    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("24h.tv"); ?> </h2>
                <hr/>
            </div>
            <!-- Page title -->
            <?php if(empty($this->val['email']) or empty($this->val['mob_tel'])){ ?>
                <div class="alert alert-warning"><?php echo T_("Чтоб воспользоваться услугой 24h.tv у вас должны быть заполнены поля  email и мобильный телефон. Обратититесь в техподдержку"); ?></div>
            <?php } else { ?>
                <!-- Page title -->
