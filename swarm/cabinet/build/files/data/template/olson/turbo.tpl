    ...
    <div class="container">
        ...
        <div class="mainy">
            ...
            <div class="page-title">
                <h2><i class="icon-desktop color"></i> <?php echo T_("Турбо"); ?> </h2>
                <hr/>
            </div>
            <!-- Page title -->
            ...
            <div class="awidget" id="step_1">
                <div class="awidget-head">
                    <h3> <?php echo T_("Подтвердите заказ услуги Турбо"); ?>:</h3>
                </div>

                <div class="awidget-body no-table-bor">

                    <?php echo $this->val['cabinet_turbo_alert']; ?>
                    <?php echo $this->val['cabinet_turbo_active_alert']; ?>
                    <form class="form-inline" action="/index/main" method="post">

                        <input type="hidden" class="form-control" name="lkview" value="turbo">

                        <div class="form-group">
                            <label class="control-label"><?php echo T_("Введите пароль"); ?>: </label>
                        </div>

                        <div class="form-group">
                            <div class="col-lg-12 ">
                                <input type="password" class="form-control" id="oldpass" name="oldpass" disabled>
                            </div>
                        </div>

                        <!-- Telephone -->
                        <div class="form-group">
                            <button type="submit" id="submit" class="btn btn-info" disabled><?php echo T_("Подтвердить"); ?></button>
                        </div>
                        <!-- Buttons -->
                    </form>
                </div>
            ...
            <div class="awidget" id="turbo_info" style="display:none">
                <div class="awidget-head">
                    <h3> <?php echo T_("Информация по услуге Турбо"); ?>:</h3>
                </div>

                <div class="awidget-body no-table-bor">
                    <table class="table">
                        <tr>
                            <td><?php echo T_("Услуга выдается на период"); ?>:</td>
                            <td> <?php echo $this->val['turbo_time']; ?> час(а)</td>
                        </tr>
                        <tr>
                            <td><?php echo T_("Входящая скорость"); ?>:</td>
                            <td><?php echo $this->val['turbo_speed_in_formate']; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo T_("Исходящая скорость"); ?>:</td>
                            <td><?php echo $this->val['turbo_speed_out_formate']; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo T_("Стоимость перехода итого"); ?>:</td>
                            <td><?php echo $this->val['turbo_active_cena']; ?> <?php echo $this->val['UE']; ?></td>
                        </tr>
                    </table>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        acctiveTurbo = <?php if(isset($this->val['turbo_active']) and $this->val['turbo_active'] == 1) echo $this->val['turbo_active']; else echo '0'; ?>;
